...
class Group extends Model
{
    ...
    public static $ALL_MEMBERS_GROUP_ID = 81;
    ...
    public function nationalCouncilPoll()
    {
        return $this->belongsToMany(CouncilNationalPoll::class,'council_national_poll_groups');
    }
}
