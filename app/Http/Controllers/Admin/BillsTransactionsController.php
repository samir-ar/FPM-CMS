...
class BillsTransactionsController extends Controller
{
    ...
    public function index(Request $request)
    {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function($row){
                    return //"<a class='edit-link' href='" . route('admin.transactions.edit', $row->id) . "'>".
                        ...
                        "<a data-toggle='modal' class='delete-link' href='#deleteModal' id='" .route('admin.bills.destroy', $row->id) . "'>".
        ...
        return view('components.table_ajax')->with([
            ...
            'headers'	=> ['id', 'Transaction ID', 'Completed', 'Success', 'Recurrent Freq', 'Amount',  'Currency', 'User Name', 'Phone Number', 'Email', 'Resp Code', 'Resp Message', 'Created at'],
            ...
            'columns' => json_encode([
                ...
                ['data' =>  'recurrent_freq', 'name'=> 'recurrent_freq'],
